			...
			<div class="g one-third palm-one-whole">
					...
					<aside class="connect">
						...
						<ul class="nav nav--banner  social">
							...
							<li>
								<a class="btn-circle btn--secondary foursquare" href="https://facebook.com/MCRfinest" target="_blank" title="Follow on Facebook"><span aria-hidden="true" class="icon-foursquare"></span><span class="accessibility">Foursquare</span></a>
							</li>
						</ul>
